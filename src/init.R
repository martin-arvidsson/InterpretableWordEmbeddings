...
args$vectors <- c('rho','alpha')
args$prior_type <- 1

# Sigmas
args$sig <- 1.0
args$sigmas$sig_n <- 0.0000001
args$sigmas$sig_d_m <- 1.0
args$sigmas$sig_pd_m <- 1.0
args$sigmas$sig_pn_m <- 1.0
args$sigmas$sig_pn_n <- 0.000001
# -----------------------------------------------------------------